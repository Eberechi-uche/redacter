...
Chart.defaults.color = "#a3a2a2";
let inputValueOne = document.getElementById("1");
let inputValueTwo = document.getElementById("2");
let inputValueThree = document.getElementById("3");
let inputValueFour = document.getElementById("4");
let inputValueFive = document.getElementById("5");
let inputValueSix = document.getElementById("6");
let inputValueSeven = document.getElementById("7");
let inputValueEight = document.getElementById("8");
...
function encrypt() {
  inputValueOne = document.getElementById("1").value.toLowerCase();
  inputValueTwo = document.getElementById("2").value.toLowerCase();
  inputValueThree = document.getElementById("3").value.toLowerCase();
  inputValueFour = document.getElementById("4").value.toLowerCase();
  inputValueFive = document.getElementById("5").value.toLowerCase();
  inputValueSix = document.getElementById("6").value.toLowerCase();
  inputValueSeven = document.getElementById("7").value.toLowerCase();
  inputValueEight = document.getElementById("8").value.toLowerCase();
